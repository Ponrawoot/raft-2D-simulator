	...
	private void setLabel(int missionNumber) {
		...
		case 0:
			requirement += "Reward: stone, rope\n" + "Requirement:\n" + " - wood "
					+ mission.getMissionRequirement(missionNumber).get(0);
			break;
		case 1:
			requirement += "Reward: metal\n" + "Requirement:\n" + " - scrap "
					+ mission.getMissionRequirement(missionNumber).get(0) + "\n" + " - rope "
					+ mission.getMissionRequirement(missionNumber).get(1);
			break;
		case 2:
		...
		case 5:
			requirement += "Reward: metal axe\n" + "Requirement:\n" + " - fruit "
					+ mission.getMissionRequirement(missionNumber).get(0) + "\n" + " - wood "
					+ mission.getMissionRequirement(missionNumber).get(1) + "\n" + " - leaf "
					+ mission.getMissionRequirement(missionNumber).get(2) + "\n" + " - metal "
					+ mission.getMissionRequirement(missionNumber).get(3);
			break;
		case 6:
